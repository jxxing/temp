     ...
     public static Map readStringXmlOut(String xml) {
         ...
         try {
             ...
             while (iterss.hasNext()) {
                 ...
                 System.out.println("result:" + result);
                 Element resultElement = (Element) recordEless.element("result");
                 result = resultElement.getText();
                 System.out.println("result:" + result);
                 result = resultElement.getTextTrim();
                 System.out.println("result:" + result);
                 result = recordEless.elementText("result");
                 System.out.println("result:" + result);
                 // 获取子节点body下的子节点form
